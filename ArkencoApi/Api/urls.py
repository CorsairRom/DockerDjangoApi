...
from ArkencoApi.Api.api import user_api_view, user_detail_view, client_api_view, client_detail_view, prospecto_api_view, prospecto_detail_view, estado_api_view, etapa_api_view
